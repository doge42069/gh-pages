...
const SectionHeader = () => {
  ...
  return (
    <HeaderContainer contentTop content grid backgroundSecondary>
      ...
      <Content>
        <Subheading><div style={{display:'inline', fontWeight:'1000'}}>THICC</div> Doge</Subheading>
        <p style={{fontSize:'70px', fontWeight:'500'}} >NFTs for you through <br/> <div style={{display:'inline', fontWeight:'1000'}}>THICC</div> and <div style={{display:'inline', fontWeight:'lighter'}}>THIN</div></p>
      </Content>
      {/*
